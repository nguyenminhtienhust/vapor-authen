...
//        let data = RegisterRequest(fullName: "Test User", phone: "test@test.com", password: "password123", confirmPassword: "password123")
//
...
//            XCTAssertEqual(user.phone, "test@test.com")
...
//        let data = RegisterRequest(fullName: "Test User", phone: "test@test.com", password: "12345678", confirmPassword: "124")
//
...
//        
//        let user = User(fullName: "Test user 1", phone: "test@test.com", passwordHash: "123")
//        try user.create(on: app.db).wait()
//                
//        let registerRequest = RegisterRequest(fullName: "Test user 2", phone: "test@test.com", password: "password123", confirmPassword: "password123")
//        try app.test(.POST, registerPath, beforeRequest: { req in
//            try req.content.encode(registerRequest)
//        }, afterResponse: { res in
//            XCTAssertResponseError(res, AuthenticationError.phoneAlreadyExists)
